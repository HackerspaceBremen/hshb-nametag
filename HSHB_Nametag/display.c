...
uint8_t specialChar(uint8_t c, uint8_t l) {
	switch(c) {
		case 196: return pgm_read_byte(&specialCharset[0][l]);
		case 132: return pgm_read_byte(&specialCharset[0][l]);
		case 209: return pgm_read_byte(&specialCharset[1][l]);
		case 145: return pgm_read_byte(&specialCharset[1][l]);
		case 214: return pgm_read_byte(&specialCharset[2][l]);
		case 150: return pgm_read_byte(&specialCharset[2][l]);
		case 220: return pgm_read_byte(&specialCharset[3][l]);
		case 156: return pgm_read_byte(&specialCharset[3][l]);
		case 223: return pgm_read_byte(&specialCharset[4][l]);
		case 159: return pgm_read_byte(&specialCharset[4][l]);
		case 228: return pgm_read_byte(&specialCharset[5][l]);
		case 164: return pgm_read_byte(&specialCharset[5][l]);
		case 241: return pgm_read_byte(&specialCharset[6][l]);
		case 177: return pgm_read_byte(&specialCharset[6][l]);
		case 246: return pgm_read_byte(&specialCharset[7][l]);
		case 182: return pgm_read_byte(&specialCharset[7][l]);
		case 252: return pgm_read_byte(&specialCharset[8][l]);
		case 188: return pgm_read_byte(&specialCharset[8][l]);
